...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form method="get" autocomplete="off" action="Model/user/connectData.php" onsubmit="return checkRegister()">
        ...
        <div class="form-container sign-in">
            ...
            <form method="POST" autocomplete="off" action="Model/user/connectData.php" onsubmit="return checkLogin()">
                <h1>Sign In</h1>
